      ...
      <div className="rounded-2xl border border-[#DDD4C5] bg-[#FFFDF8] overflow-hidden shadow-[0_4px_20px_-4px_rgba(21,21,21,0.05)]">
        <table className="w-full text-left text-xs sm:text-sm">
          ...
          <tbody className="divide-y divide-[#DDD4C5]/60">
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-[#F4F0E7]/60 transition-colors">
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-[#A374]/15 text-[#7A5720] font-serif font-bold flex items-center justify-center flex-shrink-0 border border-[#A374]/30">
                      {getInitials(u.name)}
                    </div>
                    <div>
                ...
                <td className="p-4">
                  <span className="px-2.5 py-1 text-xs font-bold uppercase bg-[#F4F0E7] text-[#7A5720] rounded-md border border-[#DDD4C5]">
                    {u.role}
                  </span>
                </td>
