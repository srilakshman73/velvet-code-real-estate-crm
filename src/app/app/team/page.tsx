          ...
          <tbody className="divide-y divide-zinc-800/60">
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-zinc-900/30 transition-colors">
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-amber-500/20 text-amber-300 font-bold flex items-center justify-center flex-shrink-0 border border-amber-500/30">
                      {getInitials(u.name)}
                    </div>
                    <div>
                ...
                <td className="p-4">
                  <span className="px-2.5 py-1 text-xs font-bold uppercase bg-zinc-800 text-amber-300 rounded-md border border-zinc-700">
                    {u.role}
                  </span>
                </td>
                <td className="p-4 text-zinc-300">{u.phone || '+91 94436 47190'}</td>
                <td className="p-4">
