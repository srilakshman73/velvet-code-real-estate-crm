 ...
 */
export function buildWhatsAppUrl(phone: string = '919443647190', messageText?: string): string {
  const cleanPhone = phone.replace(/[^0-9]/g, '');
  const encodedMsg = encodeURIComponent(
    messageText || 'Hello, I would like to know more about your Real Estate CRM.'
  );
